...
| Question #1 (Group 1, 3, 5, 7, 9)	| Question #2 (Group 2, 4, 6, 8, 10) |
|---|---|
| **Write a program that allows users to add items to their shopping cart, remove them, and view the total cost.** | **Write a program that allows users to play rock-paper-scissors against the computer.** |
