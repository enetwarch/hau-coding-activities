...
**You will be allowed to use any available IDLE for writing and running your codes.**
**You are only allowed to have the Canvas window and your IDLE open during the exam.**
...
Submit the PDF file(s) containing your program with proper documentation (comments) and output screenshots.
...
Allow the user to calculate grades for multiple students.
The program should continue asking for student details until the user decides to stop (e.g., by typing “No” when asked if they want to continue).
...
Include comments explaining key sections of your code.
Ensure the program displays all outputs in a clear and readable format.
...
|---|---|---|
| Input Validation | 10	| Correct validation of scores (0-100) |
| Decision-Making | 10 | Accurate computation of final grade and letter |
| Looping | 20 | Handles multiple students dynamically |
| Average and Highest Grade | 5	| Displays correct average and highest grade |
| Documentation and Output | 5 | Clear comments and user-friendly output |